...
const amenities = [
  ...
  },
  {
    ...
    icon: (hovered) => (
      <svg width="72" height="72" viewBox="0 0 52 52" fill="none" stroke={hovered ? '#ffffff' : '#1a1a1a'} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M26 16v10" />
        <path d="M14 26c0 0 4-6 12-6s12 6 12 6" />
        <path d="M18 26l-4 8M34 26l4 8" />
  ...
  },
  {
    ...
    icon: (hovered) => (
      <svg width="72" height="72" viewBox="0 0 52 52" fill="none" stroke={hovered ? '#ffffff' : '#1a1a1a'} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
        <path d="M10 40 Q26 14 42 40" />
        <path d="M14 40 Q26 18 38 40" />
        <path d="M18 40 Q26 22 34 40" />
        <line x1="8" y1="40" x2="44" y2="40" />
        <rect x="21" y="40" width="10" height="5" rx="1" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (hovered) => (
      <svg width="72" height="72" viewBox="0 0 52 52" fill="none" stroke={hovered ? '#ffffff' : '#1a1a1a'} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
        <path d="M18 14v8a8 8 0 0016 0v-8" />
        <line x1="26" y1="30" x2="26" y2="40" />
        <line x1="18" y1="40" x2="34" y2="40" />
        <path d="M36 14v6c0 2-1 4-3 4" />
        <path d="M36 14h4" />
      </svg>
    ),
  },
  {
    ...
    icon: (hovered) => (
      <svg width="72" height="72" viewBox="0 0 52 52" fill="none" stroke={hovered ? '#ffffff' : '#1a1a1a'} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
        <ellipse cx="26" cy="36" rx="18" ry="8" />
        <circle cx="20" cy="22" r="4" />
        <path d="M20 26l-4 10" />
        <path d="M20 26l6 6" />
        <path d="M26 32l-4 4M26 32l4 4" />
      </svg>
    ),
  },
  {
    ...
    icon: (hovered) => (
      <svg width="72" height="72" viewBox="0 0 52 52" fill="none" stroke={hovered ? '#ffffff' : '#1a1a1a'} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
        <path d="M8 42h10V34h10V26h10V18h6" />
        <path d="M14 42v-8M24 34v-8M34 26v-8" />
