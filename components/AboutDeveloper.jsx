        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p className='text-justify' style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 20px' }}>
              Ramky Group is a diversified conglomerate established in 1994, with a strong presence across real estate, infrastructure, environment management and industrial parks. Headquartered in Hyderabad, the group has delivered world-class residential and commercial developments across multiple cities in India.

              With decades of expertise, a customer-first philosophy and a commitment to quality construction, Ramky has earned the trust of thousands of homebuyers and investors. Every project reflects the group's dedication to innovation, timely delivery and thoughtful design that enhances community living.

              Ramky Codename Club Class in Thanisandra, Bangalore is a testament to this legacy — a premium gated community crafted for modern families and professionals seeking comfort, connectivity and a superior lifestyle.
            </p>
